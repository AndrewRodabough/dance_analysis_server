...
class DanceCategory:
    ...
    LATIN = {DanceStyle.SAMBA, DanceStyle.CHA_CHA, DanceStyle.RUMBA,
             DanceStyle.PASO_DOBLE, DanceStyle.JIVE}

    STANDARD = {DanceStyle.WALTZ, DanceStyle.TANGO, DanceStyle.VIENNESE_WALTZ,
                DanceStyle.FOXTROT, DanceStyle.QUICKSTEP}

    AMERICAN_SMOOTH = {DanceStyle.AMERICAN_WALTZ, DanceStyle.AMERICAN_TANGO,
                       DanceStyle.AMERICAN_FOXTROT, DanceStyle.AMERICAN_VIENNESE_WALTZ}

    AMERICAN_RHYTHM = {DanceStyle.AMERICAN_CHA_CHA, DanceStyle.AMERICAN_RUMBA,
                       DanceStyle.SWING, DanceStyle.BOLERO, DanceStyle.MAMBO}
...
class Dance(Base):
    ...
    style = Column(
        SQLEnum(DanceStyle, values_callable=lambda enum: [e.value for e in enum], name="dance_style"),
        nullable=False,
        index=True,
    )
